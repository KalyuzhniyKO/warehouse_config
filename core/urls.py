...
urlpatterns = [
    ...
    path(
        "stock/inventory/<int:pk>/export/csv/",
        views.InventoryCSVExportView.as_view(),
        name="inventory_export_csv",
    ),
    path(
        "stock/inventory/<int:pk>/export/xlsx/",
    ...
    path("stock/transfer/<int:pk>/", views.StockTransferResultView.as_view(), name="stock_transfer_result"),
    path("stock/writeoff/", views.StockWriteOffView.as_view(), name="stock_writeoff"),
